...
function EditTable() {
  ...
  useEffect(() => {
    try {
      const handleTableDetails = async () => {
    ...
    e.preventDefault();
    try {
      const res = await fetch(`/api/table/updateTable/${tableId}`, {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
        },
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        onChange={handleChanges}
                        name="reservedTime"
                        placeholder={table.reservedTime}
                        defaultValue={table.reservedTime}
                      />
                    </div>
                    <div className="space-y-2">
